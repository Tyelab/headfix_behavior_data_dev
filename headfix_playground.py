...
datadir = "Desktop/testdir/behavior/*/raw/*.csv"

# Get voltage recording files into a list
# voltage_recording = glob.glob("Y:\specialk/behavior/*")

voltage_recording = glob.glob(datadir)


print(voltage_recording)

# Load the csv into a pandas dataframe
test = pd.read_csv(voltage_recording[0], index_col="Time(ms)")
